...
if ($deleta == "s"){
	for ($i = 1; $i <= 1000; $i++){
		if (isset($_POST['chk' . $i])){
			...
			$qr  = "DELETE FROM prod_estilo WHERE prod_estilo.PRE_ESTILO = '$del' ";
			mysql_query($qr);
		}
	}
...
/* ##################### CONSULTA #####################  */
$qr = "SELECT * FROM prod_estilo ORDER BY prod_estilo.PRE_PRIORID ";
$sql = mysql_query($qr);
...
<form id="formCadEstilo" name="formCadEstilo" action="del_estilo.php?deleta=s" method="post" accept-charset="utf-8">
				...
				<table border="1" cellspacing="0" cellpadding="0" >
					<thead>
						<tr class="ui-widget-header" height="30px">
							...
							<td align="left"><font size="2"><b>Estilo</b></font></td>
					...
					<?php
						...
						while($r = mysql_fetch_array($sql)){
							echo "<tr>".
								 "<td align='center'><input type='checkbox' name='chk". $indice ."' value='". $r['PRE_ESTILO'] ."'></td>" .
								 "<td align='left'>"   . $r['PRE_ESTILO'] . "&nbsp;&nbsp;</td>" . 
								 "<td align='left'>"   . $r['PRE_ESTILO_DESC'] . "&nbsp;&nbsp;</td>" . 
								 "<td align='center'>" . $r['PRE_PRIORID'] . "</td>".
								 "</tr>";
							$indice = $indice + 1;
						}
					?>

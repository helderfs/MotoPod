...
if ($deleta == "s"){
	for ($i = 1; $i <= 1000; $i++){
		if (isset($_POST['chk' . $i])){
			...
			$qr  = "DELETE FROM prod_tam WHERE prod_tam.PRT_TAM = '$del' ";
			mysql_query($qr);
		}
	}
...
/* ##################### CONSULTA #####################  */
$qr = "SELECT * FROM prod_tam ORDER BY prod_tam.PRT_PRIORID ";
$sql = mysql_query($qr);
...
<form id="formCadTamanho" name="formCadTamanho" action="del_tamanho.php?deleta=s" method="post" accept-charset="utf-8">
				...
				<table border="1" cellspacing="0" cellpadding="0" >
					<thead>
						<tr class="ui-widget-header" height="30px">
							...
							<td align="left"><font size="2"><b>Tamanho</b></font></td>
					...
					<?php
						...
						while($r = mysql_fetch_array($sql)){
							echo "<tr>".
								 "<td align='center'><input type='checkbox' name='chk". $indice ."' value='". $r['PRT_TAM'] ."'></td>" .
								 "<td align='left'>"   . $r['PRT_TAM'] . "&nbsp;&nbsp;</td>" . 
								 "<td align='center'>" . $r['PRT_PRIORID'] . "</td>".
								 "</tr>";
							$indice = $indice + 1;
						}
					?>

	...
	<head>
		...
		<script language="javascript" type="text/javascript">			
			...
			function fnDeleta(){
				...
				for (x =0; x < window.document.frmdel_mt_mar_mod.elements.length; x++){
					if (window.document.frmdel_mt_mar_mod.elements[x].type == 'checkbox'){
						nomeCampo = window.document.frmdel_mt_mar_mod.elements[x].name;

						if (nomeCampo.substring(0,8) == "chkField"){
							if (window.document.frmdel_mt_mar_mod.elements[x].checked){
								window.document.frmdel_mt_mar_mod.hdSelDel.value = window.document.frmdel_mt_mar_mod.hdSelDel.value + "," + window.document.frmdel_mt_mar_mod.elements[x].value;
								select = true;
							}
						}
					}
				...
				if(select == false){
					...
					window.document.frmdel_mt_mar_mod.submit();
				}
			}
			...
			function selAll(){
				...
				for (x =0; x < window.document.frmdel_mt_mar_mod.elements.length; x++){
					if (window.document.frmdel_mt_mar_mod.elements[x].type == 'checkbox'){
						...
						if (nomeCampo.substring(0,8) == "chkField"){
							if (window.document.frmdel_mt_mar_mod.chkAll.checked){
								window.document.frmdel_mt_mar_mod.elements[x].checked = true;
							}else{
								window.document.frmdel_mt_mar_mod.elements[x].checked = false;
							}
						}
					}
				}
...
<form id="frmdel_mt_mar_mod" name="frmdel_mt_mar_mod" action="delmotomarmod.php" method="post" accept-charset="utf-8">
		...
		<tr height="45px">
			<td colspan="2">
				<table width="100%" border="0" cellpadding="4" cellspacing="0" bgcolor="#CBCBCB">
					<tr>
						<td align="center"><label style="font-size:18px;"><strong>Marca Modelo</strong></label></td>
					</tr>
				</table>
			</td>
		</tr>
				...
				<table border="1" cellspacing="0" cellpadding="0" >
					<thead>
						<tr class="ui-widget-header" height="30px">
							...
							<!--<td align="left"><font size="2"><b>Marca Modelo</b></font></td>-->
							<td align="left"><font size="2"><b>Modelosssss</b></font></td>
						</tr>
					</thead>
					<?php
						$indice = 1;
